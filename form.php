...
<body>
    ...
    <?php
        ...
        $sql = "INSERT INTO review (review_service, review_ambiance, review_food, review_situation, review_comment)
            VALUES ('$service', '$ambiance', '$food', '$situation', '$comment')";
        
        if ($conn->query($sql) === TRUE) {
            echo "Nouvel avis enregistré avec succès !<br><br>";
        } else {
